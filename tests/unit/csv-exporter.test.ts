...
describe('CSVExporter', () => {
  describe('formatBulkResults', () => {
    it('should format successful results correctly', () => {
      ...
      expect(lines[0]).toBe('company_id,company_name,success,smp_hostname,as4_endpoint_url,technical_contact_url,technical_info_url,error_message,processed_at');
  ...
  describe('createSummaryReport', () => {
    ...
    it('should group by SMP hostname correctly', () => {
      const results: BatchResult[] = [
        { participantId: '1', success: true, smpHostname: 'smp.example.com', processedAt: new Date() },
        { participantId: '2', success: true, smpHostname: 'smp.example.com', processedAt: new Date() },
        { participantId: '3', success: true, smpHostname: 'smp.example.com', processedAt: new Date() }
      ];
